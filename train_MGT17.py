...
parser.add_argument("--exp", type=str, default="train_MGT17_001", help="experiment")
...
parser.add_argument("--test_coordinate_path_root", type=str, default="", help="test_sketch_coordinate_dir")
